                ...
                <div class="card-body">
                    <form method="post" action="?c=auth&a=setUserData" enctype="multipart/form-data" id="editUserDataForm">
                        ...
                        <div class="form-row">
                            ...
                            <input type="number" class="form-control" name="payment" id="payment" min="0" step="0.1" <?php if($data['payment']!=null){?> value="<?=$data['payment']?>" <?php }?> required>
                        </div>
                        <?php if ($data['errorPayment'] != null) { ?>
                            <div class="alert errorMessage alert-danger alert-dismissible">
                                <a href="#" data-dismiss="alert" aria-label="close">&times;</a>
                                <strong><?= $data['errorPayment'] ?></strong>
                            </div>
                        <?php } ?>
                        <br>
                            <div>
